			...
			<div class="services-breadcrumb">
				<div class="agile_inner_breadcrumb">
					...
					<ul class="w3_short">
						...
						<li><c:out value="${product.productName}"></c:out></li>
					</ul>
				</div>
			</div>
			<!--//w3_short-->
				...
				<div class="grid images_3_of_2">
					<div class="flexslider">
						...
						<ul class="slides">
							...
							<li data-thumb="resources/images/orangeSmall.jpg">
								<div class="thumb-image">
									<img src="resources/images/orangeSmall.jpg" data-imagezoom="true"
										class="img-responsive">
								</div>
							</li>
							<li data-thumb="resources/images/pinkSmall.jpg">
								<div class="thumb-image">
									<img src="resources/images/pinkSmall.jpg" data-imagezoom="true"
										class="img-responsive">
								</div>
							</li>
						</ul>
