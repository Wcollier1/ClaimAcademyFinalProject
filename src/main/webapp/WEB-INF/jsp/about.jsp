									...
									<ul class="dropdown-menu multi-column columns-3">
										<div class="agile_inner_drop_nav_info">
											...
											<c:forEach items="${maleProducts1}" var="maleProducts1">
												<div class="col-sm-3 multi-gd-img">
													<ul class="multi-column-dropdown">
														<li><a href="menAnnuci?productID=${maleProducts1.productId}"><c:out
											...
											<c:forEach items="${maleProducts2}" var="maleProducts2">
												<div class="col-sm-3 multi-gd-img">
													<ul class="multi-column-dropdown">
														<li><a href="menAnnuci?productID=${maleProducts2.productId}"><c:out
											...
											<c:forEach items="${maleProducts3}" var="maleProducts3">
												<div class="col-sm-3 multi-gd-img">
													<ul class="multi-column-dropdown">
														<li><a href="menAnnuci?productID=${maleProducts3.productId}"><c:out
											...
											<c:forEach items="${maleProducts4}" var="maleProducts4">
												<div class="col-sm-3 multi-gd-img">
													<ul class="multi-column-dropdown">
														<li><a href="menAnnuci?productID=${maleProducts4.productId}"><c:out
									...
									<ul class="dropdown-menu multi-column columns-3">
										<div class="agile_inner_drop_nav_info">
											...
											<c:forEach items="${femaleProducts1}" var="femaleProducts1">
												<div class="col-sm-3 multi-gd-img">
													<ul class="multi-column-dropdown">
														<li><a href="womenAmberWhite?productID=${femaleProducts1.productId}"><c:out
											...
											<c:forEach items="${femaleProducts2}" var="femaleProducts2">
												<div class="col-sm-3 multi-gd-img">
													<ul class="multi-column-dropdown">
														<li><a href="womenAmberWhite?productID=${femaleProducts2.productId}"><c:out
											...
											<c:forEach items="${femaleProducts3}" var="femaleProducts3">
												<div class="col-sm-3 multi-gd-img">
													<ul class="multi-column-dropdown">
														<li><a href="womenAmberWhite"><c:out
		...
		<div class="container">
			<div class="agile_ab_w3ls_info">
				<div class="col-md-6 ab_pic_w3ls">
					<img src="resources/images/pbogw.jpg" alt=" "
						class="img-responsive" />
				</div>
				<div class="col-md-6 ab_pic_w3ls_text_info">
					<h5>
						About<span> Euphoric Ambience</span>
					</h5>
					<p>Aroma with Ambiance LLC has the finest grade "A" oils.  We have a high selection of over 800 fragrances in stock or ready to order with new fragrances arriving.  Receive your order within the same calendar week of placing your order.  Our fragrances are 100% free from alcohols. We pride ourselves in knowing we have the best quality and larger selection of scents to choose from.  Our fragrances are long lasting.  We have a long history of customers to back our reputation.  Test our product and compare it to your existing fragrances.  You will be sold by our product satisfaction (product, price and service).  We have been in business since 1997.  Ask if your preferred scent is not listed.  We appreciate your patronage and continued support.  We also reward with referral incentives.   All 100% natural fine fragrance oils.  </p>
			...
			<div class="inner_w3l_agile_grids">
				<div class="col-md-3 team-grids">
					<div class="thumbnail team-w3agile">
						<img src="resources/images/about1.jpg" class="img-responsive" alt="">
						<div class="social-icons team-icons right-w3l fotw33">
							<div class="caption">
								<h4>Tonia Simms-Collier</h4>
								<p>CEO</p>
							</div>
							<ul
				...
				<div class="col-md-3 team-grids">
					<div class="thumbnail team-w3agile">
						<img src="resources/images/about4.jpg" class="img-responsive" alt="">
						<div class="social-icons team-icons right-w3l fotw33">
							<div class="caption">
								<h4>William Collier</h4>
								<p>Java Developer</p>
							</div>
							<ul
								class="social-nav model-3d-0 footer-social w3_agile_social two">
				...
				<div class="col-md-3 team-grids">
					<div class="thumbnail team-w3agile">
						<img src="resources/images/about5.jpg" class="img-responsive" alt="">
						<div class="social-icons team-icons right-w3l fotw33">
							<div class="caption">
								<h4>Mother & Son</h4>
