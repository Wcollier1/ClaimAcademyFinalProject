...
<body>
	...
	<div class="banner-bootom-w3-agileits">
		<div class="container">
			...
			<div class="men-wear-bottom">
				...
				<div class="col-sm-8 men-wear-right">
					<h4>
						Exclusive Men's <span>Fragrance Oils</span>
					</h4>
		...
		<div class="single-pro">
			...
			<c:forEach items="${maleProducts}" var="maleProducts">

				<div class="col-md-3 product-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="resources/images/NewArrivals.jpg" alt=""
								class="pro-image-front"> <img
								src="resources/images/NewArrivals.jpg" alt=""
								class="pro-image-back">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
								
									<a href="menAnnuci?productID=${maleProducts.productId}"class="link-product-add-cart"><c:out
										value="${maleProducts.productName}"></c:out></a>
						...
						<div class="item-info-product ">
							...
							<div class="info-product-price">
								<span class="item_price"><c:out
										value="${maleProducts.price}"></c:out></span>
								<del>
									<c:out value="${maleProducts.beforePrice}"></c:out>
								</del>
							</div>
